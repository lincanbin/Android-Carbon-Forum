...
public class ApiAddress
{
	...
	*/
	...
	//Real
	public static final String DOMAIN_NAME = "http://www.94cb.com"; // PC版域名
	public static final String MOBILE_DOMAIN_NAME = "http://m.94cb.com"; // 移动版域名
	public static final String BASIC_API_URL = "http://api.94cb.com"; // API地址前缀
