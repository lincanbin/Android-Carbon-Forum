package com.lincanbin.carbbsapp.config;
public class APIAddress
{
	public static final String WEBSITE_PATH = ""; //Website path, You can leave it blank in most cases.
	public static final String API_KEY = "3372"; //Application key you set in ```config.php```
	public static final String API_SECRET = "b40484df0ad971f8ba7708d24c301c38"; //Application secret you set in ```config.php```
/*
    //Debug
...
*/
	...
	//Real
	public static final String DOMAIN_NAME = "http://www.xlz918.com" + WEBSITE_PATH; // Main domain name
	public static final String MOBILE_DOMAIN_NAME = "http://m.xlz918.com" + WEBSITE_PATH; // Domain name of mobile version
	public static final String BASIC_API_URL = "http://app.xlz918.com" + WEBSITE_PATH; // Domain name of API
