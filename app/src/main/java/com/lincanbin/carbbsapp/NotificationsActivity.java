...
import com.lincanbin.carbbsapp.adapter.PostAdapter;
import com.lincanbin.carbbsapp.application.CarbonForumApplication;
import com.lincanbin.carbbsapp.config.APIAddress;
import com.lincanbin.carbbsapp.util.HttpUtil;
import com.lincanbin.carbbsapp.util.JSONUtil;
                ...
                if(mRecyclerView != null && mSwipeRefreshLayout !=null && mAdapter != null && rootView != null && getActivity() != null) {
                    ...
                    if (list != null) {
                        if (!list.isEmpty()){
                            ...
                            Snackbar.make(rootView, R.string.nocontent, Snackbar.LENGTH_SHORT).setAction("Action", null).show();
                        }
